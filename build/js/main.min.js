...
/* harmony import */ var _modules_init_burger_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-burger-menu */ "./js/modules/init-burger-menu.js");
/* harmony import */ var _modules_init_sliders__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-sliders */ "./js/modules/init-sliders.js");
/* harmony import */ var _modules_init_facilities_tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-facilities-tabs */ "./js/modules/init-facilities-tabs.js");
...
Object(_modules_init_burger_menu__WEBPACK_IMPORTED_MODULE_2__["initBurgerMenu"])();
Object(_modules_init_sliders__WEBPACK_IMPORTED_MODULE_3__["initSliders"])();
Object(_modules_init_facilities_tabs__WEBPACK_IMPORTED_MODULE_4__["initFacilitiesTabs"])();
...
var initBurgerMenu = function initBurgerMenu() {
  if (navigation) {
    var toggle = navigation.querySelector('.main-nav__toggle');
    var overlay = navigation.querySelector('.main-nav__overlay');
    ...
    var onEscPressed = function onEscPressed(evt) {
      if (evt.code === 'Escape') {
        navigation.classList.remove('main-nav--opened');
      }
    };
...
/*!********************************************!*\
  !*** ./js/modules/init-facilities-tabs.js ***!
  \********************************************/
/*! exports provided: initFacilitiesTabs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFacilitiesTabs", function() { return initFacilitiesTabs; });
var facilitiesAlbum = document.querySelector('.facilities__album');

var initFacilitiesTabs = function initFacilitiesTabs() {
  if (facilitiesAlbum) {
    var tabs = facilitiesAlbum.querySelector('.facilities__tabs');
    var photos = facilitiesAlbum.querySelector('.facilities__photos');
    var photoHeight = photos.querySelector('img').height;

    var onTabClick = function onTabClick(evt) {
      var tab = evt.target.closest('.facilities__tab');
      var currentTab = facilitiesAlbum.querySelector('.facilities__tab--current');

      if (tab && !tab.closest('.facilities__tab--current')) {
        var shift = photoHeight * Number(tab.id);
        tab.classList.add('facilities__tab--current');
        currentTab.classList.remove('facilities__tab--current');
        photos.style.transform = "translateY(-".concat(shift, "px)");
      }
    };
...
var initIntroducingSlider = function initIntroducingSlider() {
  var introducingSlider = document.querySelector('.introducing__slider');

  if (introducingSlider) {
    var slider = new Swiper('.introducing__slider', {
      speed: 400,
      pagination: {
...
var initSpacesSlider = function initSpacesSlider() {
  var spacesSlider = document.querySelector('.spaces__slider');

  if (spacesSlider) {
    var slider = new Swiper('.spaces__slider', {
      speed: 400,
      scrollbar: {
...
var initGallerySlider = function initGallerySlider() {
  var introducingSlider = document.querySelector('.gallery__slider');
